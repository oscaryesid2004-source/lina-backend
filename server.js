// server.js — LINA Backend con manejo de errores explícito
...
// CORS (puedes volver a whitelist cuando todo funcione)
app.use(cors());
app.options('*', cors());
...
app.post('/api/ask', async (req, res) => {
  try {
    ...
    res.status(500).json({ reply: String(e?.message || e) });
  }
});
